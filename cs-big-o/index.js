...
// ANSWER:
- you could just just test if the array lenght is longer than 4 then return the 4th index
...
// ANSWER:
- you could just square the indexes of numbers array instead of making new array, making it O(1)
...
// ANSWER: 
- because each has new variables, the size of those variables is dependent on the input which is not constant